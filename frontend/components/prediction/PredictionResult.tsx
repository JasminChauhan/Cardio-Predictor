...
export function PredictionResult({ result, onReset }) {
  const [isVisible, setIsVisible] = useState(false);
  const hasDisease = result?.prediction === 1;
  const probability = result?.probability || 0.75;
  
  // Mock risk level for demo
  const riskLevel = {
    message: hasDisease ? 'Elevated Risk Detected' : 'Low Risk Profile',
    color: hasDisease ? 'from-red-900/40 to-orange-900/40' : 'from-green-900/40 to-emerald-900/40',
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden">
              ...
              <div className="text-center pt-12 pb-6 px-6 border-b border-white/5">
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    <div className={`absolute inset-0 ${hasDisease ? 'bg-red-500' : 'bg-green-500'} rounded-full blur-2xl opacity-50 animate-pulse`}></div>
              ...
              <div className="p-8 space-y-6">
                {/* Risk Level Card */}
                <div className={`relative rounded-2xl p-6 bg-gradient-to-br ${riskLevel.color} backdrop-blur-sm border-2 ${riskLevel.borderColor} overflow-hidden`}>
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-2">{riskLevel.message}</h3>
                        <p className="text-sm text-blue-100/70">
                          Risk Probability: <span className="font-semibold text-white">{(probability * 100).toFixed(1)}%</span>
                        </p>
                      </div>
                      <div className={`px-6 py-2 rounded-xl font-semibold ${
                        hasDisease 
                ...
                <div className="relative rounded-2xl p-6 bg-blue-900/20 backdrop-blur-sm border border-blue-500/20">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-white mb-3">Understanding Your Results</h4>
                ...
                <div className="relative rounded-2xl p-6 bg-purple-900/20 backdrop-blur-sm border border-purple-500/20">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h4 className="text-xl font-bold text-white">Personalized Recommendations</h4>
                  </div>
                  ...
                  <ul className="space-y-4">
                    {riskLevel.recommendations.map((recommendation, index) => (
                      ...
                      >
                        ...
                        <span className="text-blue-100/80 leading-relaxed">{recommendation}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                ...
                <div className="relative rounded-2xl p-6 bg-gradient-to-br from-amber-900/30 to-orange-900/30 backdrop-blur-sm border-2 border-amber-500/30">
                  <div className="flex items-start gap-4">
                    <div className="relative">
                      <div className="absolute inset-0 bg-amber-500 rounded-xl blur-lg opacity-50"></div>
